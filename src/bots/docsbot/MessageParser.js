class MessageParser {
  ...
  parse = (message) => {
    ...
    if (lowerCase.includes("vivoy20g")) {
      return this.actionProvider.handlevivo();
    }
    ...
    if (lowerCase.includes("help") || lowerCase.includes("h")) {
      return this.actionProvider.handleHelpfinal();
    }
   

    if (lowerCase.includes("hey")) {
      return this.actionProvider.greettwo();
    }
